...
We choose to evalute the methods \emph{multiply(other)} of the BlockMatrix and \emph{computeSVD(k)} of the IndexedRowMatrix in the distributed module of the LINALG Spark library (version 2.4.2) for Python (i.e., Pyspark)\footurl{https://spark.apache.org/docs/2.4.2/api/python/pyspark.mllib.html\#module-pyspark.mllib.linalg.distributed}.
